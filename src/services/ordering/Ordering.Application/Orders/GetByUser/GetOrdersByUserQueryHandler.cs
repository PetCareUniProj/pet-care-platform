...
internal sealed class GetOrdersByUserQueryHandler(IApplicationDbContext dbContext) : IQueryHandler<GetOrdersByUserQuery, Result<OrdersResponse>>
{
    public async ValueTask<Result<OrdersResponse>> Handle(GetOrdersByUserQuery query, CancellationToken cancellationToken)
    {
