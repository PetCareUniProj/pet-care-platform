...
public class TestServerCallContext : ServerCallContext
{
    ...
    private WriteOptions _writeOptions = new WriteOptions();
    public Metadata ResponseHeaders { get; private set; } = new Metadata();
    ...
    {
        get => _writeOptions;
        set => _writeOptions = value ?? new WriteOptions();
    }
