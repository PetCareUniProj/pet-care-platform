...
public sealed class DeleteBrandEndpointTests : BaseIntegrationTest, IClassFixture<CatalogApiFactory>
{
    ...
    public async Task DeleteAsync_ShouldReturnNoContent_WhenBrandExists()
    {
        ...
        // Act
        var response = await client.DeleteAsync(ApiEndpoints.Brands.Delete.Replace("{id:int}", brand!.Id.ToString()));
    ...
    public async Task DeleteAsync_ShouldReturnNotFound_WhenBrandDoesNotExist()
    {
        ...
        // Act
        var response = await client.DeleteAsync(ApiEndpoints.Brands.Delete.Replace("{id:int}", nonExistentId.ToString()));
    ...
    public async Task DeleteAsync_ShouldReturnNotFound_WhenBrandIsAlreadyDeleted()
    {
        ...
        await client.DeleteAsync(ApiEndpoints.Brands.Delete.Replace("{id:int}", brand!.Id.ToString()));
    ...
    public async Task DeleteAsync_ShouldReturnUnauthorized_WhenUserIsNotAuthenticated()
    {
        ...
        var nonExistentId = 1; // ID doesn't matter for unauthorized test
